declare namespace _default {
    ...
    export { getAssertion };
    export { processWebAuthnResponse };
    ...
    export function isPasskeyAutofillAvailable(): Promise<boolean>;
}
...
declare function processWebAuthnResponse(inputFunction: any, context: any): string;
